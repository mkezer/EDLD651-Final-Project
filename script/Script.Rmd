...
<!-- Maybe a brief explanation here about what social capital is just so the reader has a framework for understanding the data and analysis? -->
...
aggregate_states %>%
  ...
  geom_point() +
  p + scale_y_continuous(breaks=seq(0,2015,1)) +
  # Here I was trying to make tick marks for each year so that it would be clearer which year the data was taken in. Or maybe just label the years you have data for?
...
aggregate_country %>%
  ...
  scale_fill_discrete(name = "Type of Capital",
                      labels = c("bowling", "business", "civic", "golf", "labor", "political", "professional", "religious", "sport"))
# Here I was trying to relabel the legend labels with full words. 
