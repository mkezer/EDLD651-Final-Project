...
#create df_wides for each election
##2016
...
```{r visualization US election results, fig.width = 5, fig.height = 9, fig.margin = TRUE}
#US Election Results
...
elec_usmap_00 <- plot_usmap(data = df_wide_00, regions = "counties", values = "dem_margin") +
  scale_fill_gradient2(low = "red", 
                       ...
                       midpoint = 0, 
                       high = "blue", 
                       name = "Republican-Democratic margin") + 
...
#Arrange 4 Election Maps in 2 figures
elec_usmap_p1 <- ggarrange(elec_usmap_00,
          elec_usmap_08,
          ncol = 1)

elec_usmap_p2 <- ggarrange(elec_usmap_12,
          elec_usmap_16,
          ncol = 1)

#Annotate Combined US Election Maps
annotate_figure(elec_usmap_p1,
                top = text_grob("Figure 1. Results of US Presential Elections", face = "bold", size = 12),
                bottom = text_grob("Red and blue colors indicate Republican and Democratic lead", hjust = 1, x = 1, face = "italic", size = 10))

annotate_figure(elec_usmap_p2,
                top = text_grob("Figure 1. Results of US Presential Elections, cont'd", face = "bold", size = 12),
                bottom = text_grob("Red and blue colors indicate Republican and Democratic lead", hjust = 1, x = 1, face = "italic", size = 10))

```


```{r visualization Oregon election results, fig.width = 5, fig.height = 9}
#Oregon election Maps
elec_ormap_00 <- plot_usmap(data = df_wide_00, regions = "counties", include = c("OR"), values = "dem_margin", labels = TRUE) +
    scale_fill_gradient2(low = "red", 
                         mid = "white", 
                         midpoint = 0, 
                         high = "blue", 
...
elec_ormap_08 <- plot_usmap(data = df_wide_08, regions = "counties", include = c("OR"), values = "dem_margin", labels = TRUE) +
    scale_fill_gradient2(low = "red", 
                         mid = "white", 
                         midpoint = 0, 
                         high = "blue", 
...
elec_ormap_12 <- plot_usmap(data = df_wide_12, regions = "counties", include = c("OR"), values = "dem_margin", labels = TRUE) +
    scale_fill_gradient2(low = "red", 
                         mid = "white", 
                         midpoint = 0, 
                         high = "blue", 
...
elec_ormap_16 <- plot_usmap(data = df_wide_16, regions = "counties", include = c("OR"), values = "dem_margin", labels = TRUE) +
    scale_fill_gradient2(low = "red", 
                         mid = "white", 
                         midpoint = 0, 
                         high = "blue", 
...
#Arrange 4 Oregon Election Maps in 2 figures
elec_ormap_p1 <- ggarrange(elec_ormap_00,
          elec_ormap_08,
          ncol = 1,
          nrow = 2) 

elec_ormap_p2 <- ggarrange(elec_ormap_12,
          elec_ormap_16,
          ncol = 1,
          nrow = 2)

#Annotate Combined US Election Maps 
annotate_figure(elec_ormap_p1,
                top = text_grob("Figure 2. Results of US Presential Elections in Oregon", face = "bold", size = 12),
                bottom = text_grob("Red and blue colors indicate Republican and Democratic lead", hjust = 1, x = 1, face = "italic", size = 10))

annotate_figure(elec_ormap_p2,
                top = text_grob("Figure 2. Results of US Presential Elections in Oregon, cont'd", face = "bold", size = 12),
                bottom = text_grob("Red and blue colors indicate Republican and Democratic lead", hjust = 1, x = 1, face = "italic", size = 10))
...
aggregate_states %>%
  ...
  labs(title="Figure 3. Social Capital Trends in U.S. States",
       subtitle = "Violin plots of aggregate social capital for each state are shown \nfor the years: 1997, 2005, 2009, and 2014.",
       x="Year",
       y="Aggregate Social Capital")
#       caption = "Overlaid are boxplots representing each distribution’s minimum, maximum, medium, and first and third quartiles. \nAggregate social capital variables (described above) were multiplied by 1000 to avoid small decimal values and improve readability.")
```
...
aggregate_country2 <- aggregate_country %>%
...
aggregate_country2 %>%
  ...
  labs(title="Figure 4. Changes in Social Capital in U.S.",
       x="Year",
       y="Count",
       color="Type of Capital",
       caption = "Note. Values represent the sum for all states in the U.S., divided by total population.") +
...
Figure 4: These scatterplots show the changes in religion, civic, and labor social capital across years. 
 ...
 We separated these into three scatterplots due to the different magnitude of values. For example, the average civic social capital is `r mean(aggregate_country$civic)`, the average labor social capital is `r mean(aggregate_country$labor)`, and the average religion social capital is `r mean(aggregate_country$relig)`.
...
```{r visualization religious capital US map, fig.width = 5, fig.height = 9}
...
rel_usmap_p1 <- ggarrange(rel_usmap_00,
          rel_usmap_08,
          ncol = 1,
          nrow = 2)

rel_usmap_p2 <- ggarrange(rel_usmap_12,
          rel_usmap_16,
          ncol = 1,
          nrow = 2)
...
annotate_figure(rel_usmap_p1,
                top = text_grob("Figure 5a. Religious Social Capital in US", face = "bold", size = 12),
...
annotate_figure(rel_usmap_p2,
                top = text_grob("Figure 5a. Religious Social Capital in US, cont'd", face = "bold", size = 12),
                bottom = text_grob("Thicker color indicates higher per capita count of religious establishments", hjust = 1, x = 1, face = "italic", size = 10))


#Oregon Religious Social Capital Maps
rel_ormap_00 <- plot_usmap(data = df_wide_00, regions = "counties", include = c("OR"), values = "relig", labels = TRUE) +
...
rel_ormap_08 <- plot_usmap(data = df_wide_08, regions = "counties", include = c("OR"), values = "relig", labels = TRUE) +
  scale_fill_gradient2(low = "white", 
                        high = "red") + 
  theme(panel.background = element_rect(color = "black", fill = "white")) + 
  theme(legend.position = "none") + 
...
rel_ormap_12 <- plot_usmap(data = df_wide_12, regions = "counties", include = c("OR"), values = "relig", labels = TRUE) +
  scale_fill_gradient2(low = "white", 
                        high = "red") + 
  theme(panel.background = element_rect(color = "black", fill = "white")) + 
  theme(legend.position = "none") + 
...
rel_ormap_16 <- plot_usmap(data = df_wide_16, regions = "counties", include = c("OR"), values = "relig", labels = TRUE) +
  scale_fill_gradient2(low = "white", 
                        high = "red") + 
  theme(panel.background = element_rect(color = "black", fill = "white")) + 
  theme(legend.position = "none") + 
...
rel_ormap_p1 <- ggarrange(rel_ormap_00,
          rel_ormap_08,
          ncol = 1,
          nrow = 2)

rel_ormap_p2 <- ggarrange(rel_ormap_12,
          rel_ormap_16,
          ncol = 1,
          nrow = 2)
...
annotate_figure(rel_ormap_p1,
                top = text_grob("Figure 5b. Religious Social Capital in Oregon", face = "bold", size = 12),
                bottom = text_grob("Thicker color indicates higher per capita count of religious establishments", hjust = 1, x = 1, face = "italic", size = 10))

annotate_figure(rel_ormap_p2,
                top = text_grob("Figure 5b. Religious Social Capital in Oregon, cont'd", face = "bold", size = 12),
                bottom = text_grob("Thicker color indicates higher per capita count of religious establishments", hjust = 1, x = 1, face = "italic", size = 10))
...
```{r visualization civic social capital maps, fig.width = 5, fig.height = 9}
...
#Combine 4 US Civic Social Capital Maps in 2 figures
civ_usmap_p1 <- ggarrange(civ_usmap_00,
          civ_usmap_08,
          ncol = 1,
          nrow = 2)

civ_usmap_p2 <- ggarrange(civ_usmap_12,
          civ_usmap_16,
          ncol = 1,
          nrow = 2)

#Annotate Combined US Civic Social Capital Maps 
annotate_figure(civ_usmap_p1,
                top = text_grob("Figure 6a. Civic Social Capital in US", face = "bold", size = 12),
                bottom = text_grob("Thicker color indicates higher per capita count of civic establishments", hjust = 1, x = 1, face = "italic", size = 10))

annotate_figure(civ_usmap_p2,
                top = text_grob("Figure 6a. Civic Social Capital in US, cont'd", face = "bold", size = 12),
                bottom = text_grob("Thicker color indicates higher per capita count of civic establishments", hjust = 1, x = 1, face = "italic", size = 10))


#Oregon Civic Social Capital Maps
civ_ormap_00 <- plot_usmap(data = df_wide_00, regions = "counties", include = c("OR"), values = "civic", labels = TRUE) +
  scale_fill_gradient2(low = "white", 
                        high = "blue") + 
  theme(panel.background = element_rect(color = "black", fill = "white")) + 
  theme(legend.position = "none") + 
...
civ_ormap_08 <- plot_usmap(data = df_wide_08, regions = "counties", include = c("OR"), values = "civic", labels = TRUE) +
  scale_fill_gradient2(low = "white", 
                        high = "blue") + 
  theme(panel.background = element_rect(color = "black", fill = "white")) + 
  theme(legend.position = "none") + 
...
civ_ormap_12 <- plot_usmap(data = df_wide_12, regions = "counties", include = c("OR"), values = "civic", labels = TRUE) +
  scale_fill_gradient2(low = "white", 
                        high = "blue") + 
  theme(panel.background = element_rect(color = "black", fill = "white")) + 
  theme(legend.position = "none") + 
...
civ_ormap_16 <- plot_usmap(data = df_wide_16, regions = "counties", include = c("OR"), values = "civic", labels = TRUE) +
  scale_fill_gradient2(low = "white", 
                        high = "blue") + 
  theme(panel.background = element_rect(color = "black", fill = "white")) + 
  theme(legend.position = "none") + 
...
#Combine 4 Oregon Civic Social Capital Maps in 2 figures
civ_ormap_p1 <- ggarrange(civ_ormap_00,
          civ_ormap_08,
          ncol = 1,
          nrow = 2)

civ_ormap_p2 <- ggarrange(civ_ormap_12,
          civ_ormap_16,
          ncol = 1,
          nrow = 2)

#Annotate Combined Oregon Civic Social Capital Maps 
annotate_figure(civ_ormap_p1,
                top = text_grob("Figure 6b. Civic Social Capital in Oregon", face = "bold", size = 12),
                bottom = text_grob("Thicker color indicates higher per capita count of civic establishments", hjust = 1, x = 1, face = "italic", size = 10))

annotate_figure(civ_ormap_p2,
                top = text_grob("Figure 6b. Civic Social Capital in Oregon, cont'd", face = "bold", size = 12),
                bottom = text_grob("Thicker color indicates higher per capita count of civic establishments", hjust = 1, x = 1, face = "italic", size = 10))

```

```{r visualization labor social capital maps, fig.width = 5, fig.height = 9}
...
lab_usmap_p1 <- ggarrange(lab_usmap_00,
          lab_usmap_08,
          ncol = 1,
          nrow = 2)

lab_usmap_p2 <- ggarrange(lab_usmap_12,
          lab_usmap_16,
          ncol = 1,
          nrow = 2)

#Annotate Combined US labor Social Capital Maps 
annotate_figure(lab_usmap_p1,
                top = text_grob("Figure 7a. Labor Social Capital in US", face = "bold", size = 12),
                bottom = text_grob("Thicker color indicates higher per capita count of labor establishments", hjust = 1, x = 1, face = "italic", size = 10))

annotate_figure(lab_usmap_p2,
                top = text_grob("Figure 7b. Labor Social Capital in US, cont'd", face = "bold", size = 12),
                bottom = text_grob("Thicker color indicates higher per capita count of labor establishments", hjust = 1, x = 1, face = "italic", size = 10))


#Oregon labor Social Capital Maps
lab_ormap_00 <- plot_usmap(data = df_wide_00, regions = "counties", include = c("OR"), values = "labor", labels = TRUE) +
  scale_fill_gradient2(low = "white", 
                        high = "brown") + 
  theme(panel.background = element_rect(color = "black", fill = "white")) + 
  theme(legend.position = "none") + 
...
lab_ormap_08 <- plot_usmap(data = df_wide_08, regions = "counties", include = c("OR"), values = "labor", labels = TRUE) +
  scale_fill_gradient2(low = "white", 
                        high = "brown") + 
  theme(panel.background = element_rect(color = "black", fill = "white")) + 
  theme(legend.position = "none") + 
...
lab_ormap_12 <- plot_usmap(data = df_wide_12, regions = "counties", include = c("OR"), values = "labor", labels = TRUE) +
  scale_fill_gradient2(low = "white", 
                        high = "brown") + 
  theme(panel.background = element_rect(color = "black", fill = "white")) + 
  theme(legend.position = "none") + 
...
lab_ormap_16 <- plot_usmap(data = df_wide_16, regions = "counties", include = c("OR"), values = "labor", labels = TRUE) +
  scale_fill_gradient2(low = "white", 
                        high = "brown") + 
  theme(panel.background = element_rect(color = "black", fill = "white")) + 
  theme(legend.position = "none") + 
...
#Combine 4 Oregon Labor Social Capital Maps in 2 figures
lab_ormap_p1 <- ggarrange(lab_ormap_00,
          lab_ormap_08,
          ncol = 1,
          nrow = 2)

lab_ormap_p2 <- ggarrange(lab_ormap_12,
          lab_ormap_16,
          ncol = 1,
          nrow = 2)
...
annotate_figure(lab_ormap_p1,
                top = text_grob("Figure 7b. Labor Social Capital in Oregon", face = "bold", size = 12),
                bottom = text_grob("Thicker color indicates higher per capita count of labor establishments", hjust = 1, x = 1, face = "italic", size = 10))

annotate_figure(lab_ormap_p2,
                top = text_grob("Figure 7b. Labor Social Capital in Oregon, cont'd", face = "bold", size = 12),
                bottom = text_grob("Thicker color indicates higher per capita count of labor establishments", hjust = 1, x = 1, face = "italic", size = 10))
```
...
aggregate_election %>%
  ...
  labs(title="Figure 8. Proportion Party Votes by Social Capital in U.S. States",
       x="Aggregate Social Capital",
       y="Proportion of Votes",
       color="Party")
#       caption = "The plot shows the relationship between aggregate social capital and \nproportion of votes for political parties (democrat in blue, republican in red) over the years.")
```
