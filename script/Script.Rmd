...
```{r descriptives set up, echo = FALSE, warning = FALSE}
(table_01 <- df_wide %>% 
  group_by(state_po) %>% 
  summarize(n = n(),
...
# cor(df$pop, df$totalvotes, method = "pearson")
...
(table_4 <- table_04 %>% 
  kbl(col.names = c("County", "Religious Organizations", "Civic Associations", "Labor Organizations", "Democrat", "Republican","Voter Turnout (%)"),
      digits = 1,
      caption = "<b>Table 4</b><br /> <i>A summary table for 2008: Selected social capital and voting behavior in Oregon counties.</i>",
      align =  "c") %>%
  kable_classic(full_width = FALSE))
...
(table_5 <- table_05 %>% 
  kbl(col.names = c("County", "Religious Organizations", "Civic Associations", "Labor Organizations", "Democrat", "Republican","Voter Turnout (%)"),
      digits = 1,
      caption = "<b>Table 5</b><br /> <i>A summary table for 2012: Selected social capital and voting behavior in Oregon counties.</i>",,
      align =  "c") %>%
  kable_classic(full_width = FALSE))
...
(table_6 <- table_06 %>% 
  kbl(col.names = c("County", "Religious Organizations", "Civic Associations", "Labor Organizations", "Democrat", "Republican","Voter Turnout (%)"),
      digits = 1,
      caption = "<b>Table 6</b><br /> <i>A summary table for 2016: Selected social capital and voting behavior in Oregon counties.</i>",
      align =  "c") %>%
  kable_classic(full_width = FALSE))
